...
public class ImageSpout extends BaseRichSpout {
    ...
    public void nextTuple() {
        ...
        // 연결된 컴포넌트에 튜플 전송
        this.collector.emit(new Values(img_idx, filename, img_type, image, timestamp, enctime, sequence, header_size, img_bytes_size));
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("img_idx", "filename", "img_type", "image", "timestamp", "enctime", "sequence", "header_size", "img_bytes_size"));
    }
}